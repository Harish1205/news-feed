export const hero = [
  {
    ...
    catgeory: "featured",
    title: "Narendra Modi Vs Raghul Gandhi",
    authorName: "Salman",
    authorImg: "../images/author.jpg",
    time: "26Jan - 2024",
    desc: [
      {
        para1: "In a pivotal election, Narendra Modi highlighted his track record in development and strong leadership, emphasizing economic growth. Rahul Gandhi positioned himself as a proponent of social justice and inclusive governance, advocating for a more equitable and compassionate approach to address the country's challenges..",
      },
      {
